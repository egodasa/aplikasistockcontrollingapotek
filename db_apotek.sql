...
DROP VIEW IF EXISTS `laporan_pembelian`;
CREATE TABLE `laporan_pembelian` (`id_obat` int(11), `id_detail` int(11), `id_pemasok` int(11), `id_pembelian` varchar(50), `Nama_Obat` varchar(50), `jumlah` int(11), `harga` int(11), `Satuan` varchar(30), `Nama_Pemasok` varchar(100));
...
(12,	'Amoxilin',	20,	'Aktif',	2,	3000,	25),
